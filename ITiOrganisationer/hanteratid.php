...
<?php
    ...
    $ch = curl_init($baseurl . 'api/resource/Patient%20Appointment?filters=[["name","=","'.$_GET['appointment'].'"]]&fields=["name","appointment_date","appointment_time","practitioner_name","status","department","patient"]');
